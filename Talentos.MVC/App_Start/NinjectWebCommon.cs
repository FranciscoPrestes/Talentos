...
using Talentos.Application.Services;


[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Talentos.MVC.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Talentos.MVC.App_Start.NinjectWebCommon), "Stop")]

namespace Talentos.MVC.App_Start
{
    using System;
    using System.Web;
    ...
    using Talentos.Domain.Services;
    using Talentos.Domain.Interfaces.Repository;
    using Talentos.Infra.Data.Repositories;
